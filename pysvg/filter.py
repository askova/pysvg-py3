...
class Filter(BaseElement, CoreAttrib, XLinkAttrib, ExternalAttrib,
             StyleAttrib, PresentationAttributes_All, PointAttrib, DimensionAttrib):
    """
    Class representing the filter element of an svg doc.
    """

    def __init__(self, x=None, y=None, width=None, height=None,
                 filterRes=None, filterUnits=None, primitiveUnits=None, **kwargs):
...
class FeComponentTransfer(BaseElement, CoreAttrib,
                          FilterColorAttrib, FilterPrimitiveWithInAttrib):
    """
...
class FeComposite(FeComponentTransfer):
    ...
    def __init__(self, in2=None, operator=None, k1=None,
                 k2=None, k3=None, k4=None, **kwargs):
...
class FeConvolveMatrix(FeComponentTransfer):
    ...
    def __init__(self, order=None, kernelMatrix=None, divisor=None, bias=None, targetX=None,
                 targetY=None, edgeMode=None, kernelUnitLength=None, preserveAlpha=None, **kwargs):
...
class FeDiffuseLighting(FeComponentTransfer, StyleAttrib,
                        PaintAttrib, PresentationAttributes_LightingEffects):
    """
...
class FeGaussianBlur(FeComponentTransfer):
    ...
    def __init__(self, inValue=None, x=None, y=None, width=None,
                 height=None, stdDeviation=None, **kwargs):
...
class FeImage(BaseElement, CoreAttrib, XLinkAttrib, FilterColorAttrib,
              FilterPrimitiveAttrib, ExternalAttrib, StyleAttrib, PresentationAttributes_All):
    """
    Class representing the feImage element of an svg doc.
    """

    def __init__(self, xlink_href=None, x=None, y=None,
                 width=None, height=None, result=None, **kwargs):
...
class FeMorphology(FeComponentTransfer):
    ...
    def __init__(self, x=None, y=None, width=None, height=None,
                 operator=None, radius=None, **kwargs):
...
class FeSpecularLighting(FeComponentTransfer, StyleAttrib,
                         PaintAttrib, PresentationAttributes_LightingEffects):
    """
    Class representing the feSpecularLighting element of an svg doc.
    """

    def __init__(self, lighting_color=None, surfaceScale=None, specularConstant=None,
                 specularExponent=None, kernelUnitLength=None, **kwargs):
...
class feTurbulence(BaseElement, CoreAttrib,
                   FilterColorAttrib, FilterPrimitiveAttrib):
    """
...
class FeSpotLight(FePointLight):
    ...
    def __init__(self, x=None, y=None, z=None, pointsAtX=None, pointsAtY=None,
                 pointsAtZ=None, specularExponent=None, limitingConeAngle=None, **kwargs):
...
class FeFuncR(BaseElement, CoreAttrib):
    ...
    def __init__(self, type=None, tableValues=None, slope=None,
                 intercept=None, amplitude=None, exponent=None, offset=None, **kwargs):
