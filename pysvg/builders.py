...
class ShapeBuilder:
    ...
    def createRect(self, x, y, width, height, rx=None, ry=None,
...
class StyleBuilder:
    ...
    # is used to provide a potential indirect value (currentColor) for the
    # 'fill', 'stroke', 'stop-color' properties.
...
class TransformBuilder:
    ...
    def setMatrix(self, a, b, c, d, e, f):
        self.transform_dict["matrix"] = 'matrix(%s %s %s %s %s %s)' % (
            a, b, c, d, e, f)
