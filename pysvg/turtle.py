...
class Turtle(object):
    ...
    def __init__(self, initialPosition=Vector(0.0, 0.0), initialOrientation=Vector(
            1.0, 0.0), fill='white', stroke='black', strokeWidth='1', penDown=False):
    ...
    def _addPolylineToElements(self):
        ...
        self._pointsOfPolyline = []
        self._pointsOfPolyline.append(
            Vector(self._position.x, self._position.y))
