...
class Rect(BaseShape, PointAttrib, DimensionAttrib):
    ...
    def __init__(self, x=None, y=None, width=None,
                 height=None, rx=None, ry=None, **kwargs):
    ...
    # extra methods. Methods do rely on number values in the attributes. You
    # might get an exception else!
    ...
    def getBottomRight(self):
        ...
        return (float(self.get_x()) +
                float(self.get_width()), float(self.get_y()))
    ...
    def getTopLeft(self):
        ...
        Requires the coordinates, width, height to be numbers
        """
        return (float(self.get_x()), float(
            self.get_y()) + float(self.get_height()))
...
class Path(BaseShape, ExternalAttrib, MarkerAttrib):
    ...
    def appendCubicCurveToPath(self, controlstartx, controlstarty,
                               controlendx, controlendy, endx, endy, relative=True):
        self.__append__('c',
                        [controlstartx,
                         controlstarty,
                         controlendx,
    ...
    def appendQuadraticCurveToPath(
            self, controlx, controly, endx, endy, relative=True):
    ...
    def appendArcToPath(self, rx, ry, x, y, x_axis_rotation=0,
        ...
        self.__append__('a', [rx, ry, x_axis_rotation,
                              large_arc_flag, sweep_flag, x, y], relative)
